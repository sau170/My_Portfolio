    ...
    <nav className={`navbar${scrolled ? ' scrolled' : ''}`}>
      ...
      <div className="container">
        <span className="nav-logo">
          <span className="bracket">&lt;</span>Saurabh
          <span className="slash">/</span>Birari
        ...
        <div className="nav-icons">
          <a href="" target="_blank" rel="noreferrer" className="nav-icon" title="GitHub">
          ...
          <a href="https://www.linkedin.com/in/saurabh-birari-388643235?utm_source=share_via&utm_content=profile&utm_medium=member_ios" target="_blank" rel="noreferrer" className="nav-icon" title="LinkedIn">
