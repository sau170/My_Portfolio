...
const roles = ['React.js Developer', 'Front-End Developer', 'Good Learner', 'Problem Solver']
    ...
    <section className="hero" id="home">
      ...
      <div className="container">
        ...
        <div className="hero-left" style={{ animation: 'fadeInUp 0.7s ease both' }}>
          ...
          <h1 className="hero-name">SAURABH<br />BIRARI</h1>
          ...
          <p className="hero-desc">
            Passionate Front-End Developer with 2+ years of experience in IT industry,specializing in desgining & developing responsive,user-friendly web application using HTML,CSS,,JavaScript & React.js
          </p>
          ...
          <div className="hero-socials">
            <a href="" target="_blank" rel="noreferrer" className="hero-soc">
            ...
            <a href="mailto:saurabhbirari9999@gmail.com" className="hero-soc">
          ...
          <div className="hero-stats">
            {[['2+', 'Years Exp.'], ['3+', 'Projects'], ['10+', 'Tech Stack'], ['8.78', 'CGPA']].map(([n, l]) => (
